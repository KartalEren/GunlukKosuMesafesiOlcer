namespace GunlukKosuMesafesiOlcer
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            bool tekrarEtmekIsterMisin = false;
            ...
            do
            {
                ...
                tekrarEtmekIsterMisin = DevamEdilecekMiSor("Tekrar hesaplamak ister misiniz ? Evet ise lütfen 1'e basınız : ");

            } while (tekrarEtmekIsterMisin);
